...
| dcat:Dataset      | prov:wasGeneratedBy            | custom:was_generated_by                    |                                | text      |                                                                                                                                                               |
...
| foaf:Agent        | dct:spatial                    | custom:publisher_country                   |                                | text      |  URI from the [EU Publications Office country authority table](http://publications.europa.eu/resource/authority/country) |
...
| foaf:Agent        | dct:spatial                    | custom:creator_country                     |                                | text      |  URI from the [EU Publications Office country authority table](http://publications.europa.eu/resource/authority/country) |
